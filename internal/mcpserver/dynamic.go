...
// modules that contributed tools to the catalog (kept for future use / parity
// with the Python DynamicMode constructor).
...
// prefix and default annotations too. falcon_list_enabled_modules is registered
// by coreTools.registerAlwaysOn, not here.
