...
|hostname|String|No|The name of the machine. LIMITED wildcard support: - hostname:'PC*' (prefix) - WORKS - hostname:'*-01' (suffix) - WORKS - hostname:'*server*' (contains) - FAILS Ex: hostname:'WinPC9251' or hostname:'PC*'|
