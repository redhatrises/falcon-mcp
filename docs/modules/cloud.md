...
<!-- meta:description Search Falcon cloud resources: Kubernetes containers, image vulnerabilities, CSPM assets, IOM findings, cloud risks, cloud groups, suppression rules, and cloud insights -->
<!-- meta:section modules -->
<!-- meta:link-base /falcon-mcp/ -->
<!-- frontmatter:sidebar order:10 -->

Search Falcon cloud resources: Kubernetes containers, image vulnerabilities, CSPM assets, IOM findings, cloud risks, cloud groups, suppression rules, and cloud insights
