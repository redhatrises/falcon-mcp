...
<!-- meta:description Search and run Fusion SOAR workflows and read their execution results -->
<!-- meta:section modules -->
<!-- meta:link-base /falcon-mcp/ -->
<!-- frontmatter:sidebar order:10 -->

Search and run Fusion SOAR workflows and read their execution results
